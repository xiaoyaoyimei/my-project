...
<script>
    let Vue = require('vue')
    let ajax = require('../service/base.js')
   ...
   export default {
        ...
        created() {
            ...
            let getcol = require('../components/columns.js')
        ...
        computed: {
            items() {
                return require('../utils/filterBy.js')(this.rows, this.columns, this.q)
            }
        },
        components: {
            ShowColumns: require('../components/ShowColumns.vue'),
            TableServer: require('../components/TableServer.vue')
        },
